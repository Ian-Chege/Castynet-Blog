---
title: Writing JavaScript Outside the Browser
date: '2023-02-20'
tags: ['JavaScript', 'RunJS', 'programming', 'web development', 'debugging']
draft: false
summary: "JavaScript is not just for browsers. This article explores how JavaScript can be used outside the browser using tools like RunJS, which allows you to write and get immediate feedback on your JavaScript code right in your text editor."
authors: ['maxriunge']
---
